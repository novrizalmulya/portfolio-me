...
import { FiMail, FiMessageSquare, FiUser, FiSend, FiGithub, FiLinkedin, FiInstagram } from 'react-icons/fi'
      ...
      <div className="section-container">
        ...
        <div className="mb-16" data-aos="fade-up">
          ...
          <h2 className="section-title">
            Contact <span className="italic" style={{ color: 'var(--color-accent)' }}>Me</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6 mb-10">
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: 'var(--color-cream-200)' }}
                >
                  <FiMessageSquare size={18} style={{ color: 'var(--color-accent)' }} />
                </div>
                <div>
                  <p
                    className="text-xs uppercase tracking-wider mb-1"
          ...
          <div data-aos="fade-left" data-aos-delay="150">
            <form
              ...
              className="rounded-2xl p-7 space-y-5 border"
              style={{
                backgroundColor: 'rgba(255,255,255,0.7)',
                borderColor: 'rgba(26,26,26,0.08)',
              }}
            >
              ...
              <div>
                <label
                  ...
                  style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-ink-500)' }}
                >
                  Nama
                </label>
              ...
              <div>
                ...
                <textarea
                  ...
                  value={form.message}
                  onChange={handleChange}
                  placeholder="jangan ragu buat ngirim pesan"
                  rows={5}
                  required
                  className="w-full px-4 py-3 rounded-xl text-sm outline-none transition-all resize-none border"
                  style={{
                    backgroundColor: 'var(--color-cream-50)',
                    borderColor: 'rgba(26,26,26,0.1)',
                    color: 'var(--color-ink-800)',
              ...
              <button
                ...
                style={{
                  backgroundColor: status === 'success' ? '#22c55e' : 'var(--color-ink-900)',
